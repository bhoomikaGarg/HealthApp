...
import com.example.healthapp.Adapter.Slider_gym.SliderAdapter_gym_advance_day2
import com.example.healthapp.R

class Gym_Activity_advance_day2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sliderAdapter =
            SliderAdapter_gym_advance_day2(
                this
            )
